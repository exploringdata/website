var nodeinfo = function(dataid, data, name) {
  ...
  if (data.twitter_url)
    desc += '<a class="btn" href="' + data.twitter_url + '"><i class="glyphicon glyphicon-twitter"></i></a> ';
  if (data.facebook_url)
    desc += '<a class="btn" href="' + data.facebook_url + '"><i class="glyphicon glyphicon-facebook"></i></a> ';
  if (data.gplus_url)
