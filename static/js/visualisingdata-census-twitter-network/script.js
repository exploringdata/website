...
var nodeinfo = function(data) {
  ...
  desc += '<p><i class="glyphicon glyphicon-twitter"></i> <a href="https://twitter.com/' + data.screen_name + '">Twitter Profile</a>';
  if (data.url.length > 0)
    desc += ' | <i class="glyphicon glyphicon-home"></i> <a href="' + data.url + '">Homepage</a>';
  desc += '</p>';
