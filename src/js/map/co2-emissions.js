...
colors = ['#f9ffe2', '#edf0d4', '#e1e1c5', '#d5d2b8', '#c9c3aa', '#bdb59d', '#b2a790', '#a69983', '#9a8b76', '#8e7e6a', '#82715e', '#766453', '#6a5848', '#5e4c3d', '#524033', '#46352a', '#3a2a21', '#2e2019', '#211712', '#0d0d0d'];
...
let map = d3.choropleth()
    ...
    .unitId('iso3')
    .postUpdate(() => {
        annotate(map, 114, 120, `CO2 emissions (metric tons per capita) in ${selected_col}`, data_source=data_source);
    });
