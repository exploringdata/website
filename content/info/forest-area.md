...
description: "Information on choropleth maps showing the forest area percentage of land area for the world's countries based on data from the World Bank."
...
The underlying data comes from the Food and Agriculture Organization and is published on the [World Bank website](https://data.worldbank.org/indicator/AG.LND.FRST.ZS), where it is described as:
